...
/// ST_Contains() implementation using geo::Contains
/// ST_Contains(A, B) returns true if A contains B
...
impl SedonaScalarKernel for STContains {
...
mod tests {
    ...
    use sedona_functions::register::stubs::st_contains_udf;
    ...
    #[test]
    fn scalar_scalar() {
        let mut udf = st_contains_udf();
        udf.add_kernel(st_contains_impl());
        ...
        // Point does not contain polygon
        assert_eq!(
            tester
        ...
        // Polygon does not contain point2
        assert_eq!(
            tester
    ...
    fn scalar_array() {
        ...
        // Polygon contains array of points -> Array
        ...
        // Array of points do not contain polygon -> Array
    ...
    fn array_array() {
        ...
        assert_eq!(
            &tester
                .invoke_array_array(polygon_array, point_array)
                .unwrap(),
            &expected
        );
    }
